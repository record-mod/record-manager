package dev.tralwdwd.record.manager.ui.screen.installer
...
import dev.tralwdwd.record.manager.installer.step.StepStatus
import dev.tralwdwd.record.manager.ui.viewmodel.installer.InstallerViewModel
import dev.tralwdwd.record.manager.ui.widgets.dialog.BackWarningDialog
import dev.tralwdwd.record.manager.ui.widgets.dialog.DownloadFailedDialog
import dev.tralwdwd.record.manager.ui.widgets.installer.StepGroupCard
...
class InstallerScreen(
    ...
    override fun Content() {
        ...
        val intentListener: (Intent) -> Unit = remember {
            {
                val msg = it.getStringExtra("record.extras.EXTRA_MESSAGE")
