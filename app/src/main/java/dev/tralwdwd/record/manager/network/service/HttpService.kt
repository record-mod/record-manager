package dev.tralwdwd.record.manager.network.service

import dev.tralwdwd.record.manager.network.utils.ApiError
import dev.tralwdwd.record.manager.network.utils.ApiFailure
