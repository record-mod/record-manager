...
import dev.tralwdwd.record.manager.installer.step.download.DownloadBaseStep
import dev.tralwdwd.record.manager.installer.step.download.DownloadLangStep
import dev.tralwdwd.record.manager.installer.step.download.DownloadLibsStep
import dev.tralwdwd.record.manager.installer.step.download.DownloadResourcesStep
import dev.tralwdwd.record.manager.installer.step.download.DownloadModStep
import dev.tralwdwd.record.manager.installer.step.installing.InstallStep
import dev.tralwdwd.record.manager.installer.step.patching.AddModStep
import dev.tralwdwd.record.manager.installer.step.patching.PatchManifestsStep
import dev.tralwdwd.record.manager.installer.step.patching.PresignApksStep
import dev.tralwdwd.record.manager.installer.step.patching.ReplaceIconStep
import dev.tralwdwd.record.manager.installer.util.LogEntry
import dev.tralwdwd.record.manager.installer.util.Logger
 ...
 *
 * @param discordVersion Version of Discord to inject ReCord into
 */
@Stable
class StepRunner(
