...
import dev.tralwdwd.record.manager.installer.utils.ArscUtil
import dev.tralwdwd.record.manager.installer.utils.ArscUtil.addColorResource
import dev.tralwdwd.record.manager.installer.utils.ArscUtil.getMainArscChunk
import dev.tralwdwd.record.manager.installer.utils.ArscUtil.getPackageChunk
import dev.tralwdwd.record.manager.installer.utils.ArscUtil.getResourceFileName
import dev.tralwdwd.record.manager.installer.utils.AxmlUtil
import dev.tralwdwd.record.manager.utils.DiscordVersion
import org.koin.core.component.inject

/**
 * Replaces the existing app icons with ReCord tinted ones
 */
