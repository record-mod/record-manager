package dev.tralwdwd.record.manager.domain.manager
...
import dev.tralwdwd.record.manager.domain.manager.base.BasePreferenceManager
...
class PreferenceManager(context: Context) :
    ...
    val DEFAULT_MODULE_URL = "https://github.com/record-mod/record-xposed/releases/latest/download/app-release.apk"
    ...
    var moduleUrl by stringPreference("module_url", DEFAULT_MODULE_URL)
