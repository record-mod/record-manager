package dev.tralwdwd.record.manager.ui.screen.settings
...
import dev.tralwdwd.record.manager.ui.components.settings.SettingsButton
import dev.tralwdwd.record.manager.ui.components.settings.SettingsSwitch
import dev.tralwdwd.record.manager.ui.components.settings.SettingsTextField
import dev.tralwdwd.record.manager.ui.viewmodel.settings.DeveloperSettingsViewModel
import dev.tralwdwd.record.manager.utils.DimenUtils
...
class DeveloperSettings: Screen {
    ...
    override fun Content() {
        val viewModel: DeveloperSettingsViewModel = getScreenModel()
        ...
        var moduleUrl by remember { mutableStateOf(prefs.moduleUrl) }
        ...
        Scaffold(
            ...
            Column(
                ...
                // Debounce
                LaunchedEffect(moduleUrl) {
                    delay(500)
                    prefs.moduleUrl = moduleUrl
                ...
                SettingsButton(
                    ...
                    onClick = {
                        prefs.moduleUrl = prefs.DEFAULT_MODULE_URL
                        viewModel.clearCache()
                    }
                )
