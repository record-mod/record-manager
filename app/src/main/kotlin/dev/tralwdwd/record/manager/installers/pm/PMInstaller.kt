package dev.tralwdwd.record.manager.installers.pm
...
import dev.tralwdwd.record.manager.installers.Installer
...
class PMInstaller(
    ...
    override suspend fun waitUninstall(packageName: String) = suspendCancellableCoroutine<InstallerResult> { continuation ->
        // Create and register a result receiver
        val relayReceiver = PMUtils.registerRelayReceiver(
            context = context,
            sessionId = -1,
