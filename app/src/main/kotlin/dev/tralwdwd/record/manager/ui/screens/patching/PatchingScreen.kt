...
import dev.tralwdwd.record.manager.ui.components.MainActionButton
import dev.tralwdwd.record.manager.ui.components.Wakelock
import dev.tralwdwd.record.manager.ui.components.dialogs.InstallerAbortDialog
import dev.tralwdwd.record.manager.ui.screens.log.LogScreen
import dev.tralwdwd.record.manager.ui.screens.patching.components.*
import dev.tralwdwd.record.manager.ui.screens.patchopts.PatchOptions
import dev.tralwdwd.record.manager.ui.theme.customColors
import dev.tralwdwd.record.manager.ui.util.paddings.*
import dev.tralwdwd.record.manager.ui.util.spacedByLastAtBottom
import dev.tralwdwd.record.manager.ui.util.thenIf
import dev.tralwdwd.record.manager.util.back
import dev.tralwdwd.record.manager.util.isIgnoringBatteryOptimizations
