...
import dev.tralwdwd.record.manager.util.serialization.ColorParceler
import dev.tralwdwd.record.manager.util.serialization.ColorSerializer
...
data class PatchOptions(
    ...
    sealed interface IconReplacement : Parcelable {
        ...
        companion object {
            ...
            /**
             * The default ReCord color.
             */
            val ReCordColor = Color(0xFF1E1F22)
    ...
    companion object {
        val Default =
                PatchOptions(
                        appName = "ReCord",
                        packageName = "dev.tralwdwd.record",
                        debuggable = false,
                        iconReplacement = IconReplacement.CustomColor(IconReplacement.ReCordColor),
