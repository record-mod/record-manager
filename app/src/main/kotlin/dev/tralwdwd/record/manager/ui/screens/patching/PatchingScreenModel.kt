...
import dev.tralwdwd.record.manager.patcher.ReCordPatchRunner
import dev.tralwdwd.record.manager.patcher.steps.StepGroup
import dev.tralwdwd.record.manager.patcher.steps.base.*
import dev.tralwdwd.record.manager.patcher.steps.install.InstallStep
import dev.tralwdwd.record.manager.patcher.util.InsufficientStorageException
...
class PatchingScreenModel(
    ...
    private suspend fun startPatchRunner() {
        val runner = ReCordPatchRunner(options)
            .also { stepRunner = it }
