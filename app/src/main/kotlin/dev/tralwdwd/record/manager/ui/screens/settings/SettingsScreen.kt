...
import dev.tralwdwd.record.manager.ui.components.settings.*
import dev.tralwdwd.record.manager.ui.screens.settings.components.ThemeDialog
import dev.tralwdwd.record.manager.ui.screens.settings.components.InstallerDialog
import dev.tralwdwd.record.manager.ui.screens.settings.components.ShizukuInfoDialog
import dev.tralwdwd.record.manager.manager.InstallerSetting
import dev.tralwdwd.record.manager.manager.toDisplayName
                        ...
                        Icon(
                            painter = painterResource(
                                when (preferences.theme) {
                                    dev.tralwdwd.record.manager.ui.theme.Theme.Dark -> R.drawable.ic_night
                                    dev.tralwdwd.record.manager.ui.theme.Theme.Light -> R.drawable.ic_light
                                    dev.tralwdwd.record.manager.ui.theme.Theme.System -> R.drawable.ic_sync
                                }
                            ),
