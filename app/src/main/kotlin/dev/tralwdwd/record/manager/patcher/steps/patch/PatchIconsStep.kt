...
import dev.tralwdwd.record.manager.patcher.util.ArscUtil
import dev.tralwdwd.record.manager.patcher.util.ArscUtil.addColorResource
import dev.tralwdwd.record.manager.patcher.util.ArscUtil.addResource
import dev.tralwdwd.record.manager.patcher.util.ArscUtil.getMainArscChunk
import dev.tralwdwd.record.manager.patcher.util.ArscUtil.getPackageChunk
import dev.tralwdwd.record.manager.patcher.util.ArscUtil.getResourceFileName
import dev.tralwdwd.record.manager.patcher.util.ArscUtil.getResourceFileNames
import dev.tralwdwd.record.manager.patcher.util.AxmlUtil
import dev.tralwdwd.record.manager.ui.screens.patchopts.PatchOptions
import dev.tralwdwd.record.manager.ui.screens.patchopts.PatchOptions.IconReplacement
import dev.tralwdwd.record.manager.util.getResBytes
