...
class IconOptionsModel(
    ...
    init {
        when (prefilledOptions) {
            is IconReplacement.CustomColor if prefilledOptions.color == IconReplacement.ReCordColor -> {
                changeMode(IconOptionsMode.ReCord)
                initSelectedColor(IconReplacement.ReCordColor)
            }
    ...
    fun generateConfig(): IconReplacement? {
        return when (mode) {
            ...
            IconOptionsMode.ReCord -> IconReplacement.CustomColor(IconReplacement.ReCordColor)
