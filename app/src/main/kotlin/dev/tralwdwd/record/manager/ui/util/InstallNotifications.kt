package dev.tralwdwd.record.manager.ui.util
...
import dev.tralwdwd.record.manager.MainActivity
import dev.tralwdwd.record.manager.util.findActivity
    ...
    fun createNotification(
        ...
        val notification =
                NotificationCompat.Builder(context, CHANNEL_ID)
                        ...
                        .setAutoCancel(true)
                        .setSmallIcon(R.drawable.ic_record_title)
