package dev.tralwdwd.record.manager.ui.widgets.updater
...
import dev.tralwdwd.record.manager.manager.download.IDownloadManager
...
class UpdaterViewModel(
	private val github: ReCordGithubService,
    ...
    private fun launchReleasesPage() {
        try {
            Intent(Intent.ACTION_VIEW, "https://github.com/${ReCordGithubService.ORG}/${ReCordGithubService.MANAGER_REPO}/releases".toUri())
