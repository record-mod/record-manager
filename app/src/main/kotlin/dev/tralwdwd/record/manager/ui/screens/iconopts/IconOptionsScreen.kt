package dev.tralwdwd.record.manager.ui.screens.iconopts
...
import dev.tralwdwd.record.manager.ui.screens.iconopts.components.*
import dev.tralwdwd.record.manager.ui.screens.patchopts.PatchOptions
import dev.tralwdwd.record.manager.ui.screens.patchopts.PatchOptionsScreen
import dev.tralwdwd.record.manager.ui.util.ColorSaver
import dev.tralwdwd.record.manager.ui.util.throttledState
import dev.tralwdwd.record.manager.util.back
...
fun IconOptionsScreenContent(
    ...
    Scaffold(
        ...
        Column(
            ...
            RadioSelectorItem(
                name = stringResource(R.string.record),
                description = stringResource(R.string.iconopts_variant_desc_record),
                selected = mode == IconOptionsMode.ReCord,
                onClick = remember { { setMode(IconOptionsMode.ReCord) } },
            )
            RadioSelectorItem(
