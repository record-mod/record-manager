package dev.tralwdwd.record.manager.ui.components
...
fun ProjectHeader(
    ...
    Column(
        ...
        Image(
                painter =
                        painterResource(
                                ...
                                else R.drawable.ic_record_title
                        ),
        ...
        Text(
                text = stringResource(if (aliucord) R.string.aliucord else R.string.record),
        ...
        Row(
            ...
            TextButton(
                    onClick = { uriHandler.openUri("https://github.com/${BuildConfig.GITHUB_ORG}/${BuildConfig.GITHUB_REPO}") }
            ) {
                Icon(
