...
android {
    ...
    defaultConfig {
        applicationId = "dev.tralwdwd.record.manager"
        minSdk = 28
        targetSdk = 34
        ...
        buildConfigField("String", "MOD_NAME", "\"ReCord\"")
        buildConfigField("String", "MANAGER_NAME", "\"ReCordManager\"")
        buildConfigField("String", "REPO", "\"record-mod/record-bundle\"")
        buildConfigField("String", "ORG_LINK", "\"https://github.com/record-mod\"")
        buildConfigField("String", "INVITE_LINK", "\"https://discord.gg/ddcQf3s2Uq\"")
        buildConfigField("String", "MODDED_APP_PACKAGE_NAME", "\"app.record\"")
        buildConfigField("int", "MODDED_APP_ICON", "0xFF1E1F22")
        buildConfigField("int", "MODDED_APP_ICON_ALPHA", "0xFFFBB33C")
        buildConfigField("int", "MODDED_APP_ICON_OTHER", "0xFF5865F2")
